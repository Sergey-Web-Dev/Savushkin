...
const Header = () => {
  return (
    <header className="w-full">
      <div className="relative w-full  flex justify-center items-center gap-12 font-rotonda pt-6 pl-48">
        ...
        <div className="relative w-[187px] h-[100px] group hover:cursor-pointer font-rotonda ">
          <h1 className="absolute z-10 text-xl font-semibold uppercase top-[50%] translate-y-[-25%] translate-x-[30%] text-blue-600 group-hover:text-rose-700">
            фотоотчёт
          </h1>
          <img
